...
public class SpawnWall_2 : MonoBehaviour
{
    ...
    void SpawnZombie()
    {
        ...
        for (int i = 0; i < 50; i++)
        {
            ...
            GameObject zombieTemp = Instantiate(Zombie, spawnPoint[3].position + new Vector3(positionOffset_X, 0, positionOffset_Z), Quaternion.Euler(0, angleOffset, 0)); //生成殭屍
        ...
        for (int i = 0; i < 33; i++)
        {
            ...
            GameObject zombieTemp = Instantiate(Zombie, spawnPoint[4].position + new Vector3(positionOffset_X, 0, positionOffset_Z), Quaternion.Euler(0, angleOffset, 0)); //生成殭屍
        ...
        for (int i = 0; i < 33; i++)
        {
            ...
            GameObject zombieTemp = Instantiate(Zombie, spawnPoint[5].position + new Vector3(positionOffset_X, 0, positionOffset_Z), Quaternion.Euler(0, angleOffset, 0)); //生成殭屍
        ...
        for (int i = 0; i < 33; i++)
        {
            ...
            GameObject zombieTemp = Instantiate(Zombie, spawnPoint[6].position + new Vector3(positionOffset_X, 0, positionOffset_Z), Quaternion.Euler(0, angleOffset, 0)); //生成殭屍
