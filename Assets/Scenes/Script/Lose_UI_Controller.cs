...
public class Lose_UI_Controller : MonoBehaviour
{
    bool IsHied = true;

    public Image black_background;
    public Image lose_pictrue;
    public Image lose_background;
    ...
    private IEnumerator __show()
    {
        ...
        while (true)
        {
            ...
            c = Mathf.Lerp(c, 150f, 0.01f);
            d = Mathf.Lerp(d, 255f, 0.01f);


            black_background.color = new Color(0 / 255f, 0 / 255f, 0 / 255f, a / 255f);
            lose_pictrue.color = new Color(255f / 255f, 255f / 255f, 255f / 255f, b / 255f);
            lose_background.color = new Color(255f / 255f, 255f / 255f, 255f / 255f, c / 255f);
